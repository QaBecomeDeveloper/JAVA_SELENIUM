...
public class DbManager {
		...
		{
			/*
			 * try{ Class.forName(TestConfig.driver); con =
			 * DriverManager.getConnection(TestConfig.dbConnectionUrl,
			 ...
			 * TestConfig.
			 * subject+" - (Script failed with Error, Datamart database used for reports, connection not established)"
